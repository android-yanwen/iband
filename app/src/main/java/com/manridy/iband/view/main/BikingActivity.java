...
//        timeutils=new Timeutils(tv_exercise_time);
        tv_sport_mode.setText(R.string.hint_cycling);
    }
...
//            timeutils.startTimer();
            ...
            locationServiceBinder.saveRunLocationRecord(1003);
        }
...
//                timeutils.puseTimer();
            ...
            case R.id.iv_end_run:
                final AlertDialog.Builder builder = new AlertDialog.Builder(BikingActivity.this);
...
//                startActivity(CountDownActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(BikingActivity.this,LocationService.class);
