...
public class AlertBigItemsButton extends RelativeLayout {

    ImageView alertImg;

    public AlertBigItemsButton(Context context) {
        super(context);
    }

    public AlertBigItemsButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        View view = View.inflate(context, R.layout.item_alert_big_button,this);
